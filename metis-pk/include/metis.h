...
METIS_API(int) METIS_Interface_LayerTwo(char* method, int contig, int nVerticesIn, int numEdgesIn, int nPartsIn, int nConIn, int ufactorIn,
        int xadjIn[], int xadjncyIn[], int adjwgtIn[], int vwgtIn[], int partAns[]);

METIS_API(int) METIS_Interface(char* method, int contig, int nVerticesIn, int numEdgesIn, int nPartsIn, int nConIn, int ufactorIn,
